import type { socialMedia, explore, project } from "./types.ts";

export const socialMediaLogos: socialMedia[] = [
    {
        id: 1,
        name: "instagram",
...
export const exploreNav: explore[] = [
    {name: "Home", link: ""},
    {name: "Favorites", link: "faves"},
...
export const projects: project[] = [
    {name: "Frontend Portfolio", link: "https://fabianmadrid.dev"},
    {name: "Fabian Gallery Design", link: ""},
    {name: "Code on GitHub", link: "https://github.com/SergioMadrid522/photographyBlog"},
];
