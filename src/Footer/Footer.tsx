...
function SocialMediaContent() {
  const socialMediaLogos = [
    ...
    {
      name: "linkedin",
      link: "https://www.linkedin.com/in/sergio-fabian-acu%C3%B1a-madrid-59735336b/",
  ...
  return (
    <div className="social-media-container" id="contact">
      ...
      <nav>
        <ul>
          {socialMediaLogos.map((media, index) => (
            <li key={index}>
    ...
    <div className="project-container">
      ...
      <nav>
        <ul>
          ...
          <li>
            <a href="/">Fabian Gallery Design</a>
          </li>
          <li>
            <a
              href="https://github.com/SergioMadrid522/photographyBlog"
              target="_blank"
            >
              Code on GitHub
            </a>
  ...
  return (
    <div className="credits-container">
      ...
      <div className="credits-list">
        <ul>
          <li>Made with ❤️ by Fabian</li>
          <li>Powered by React & Figma</li>
          <li>All photos © Fabian</li>
          <li>Portfolio Project &#45; 2025</li>
        </ul>
      </div>
    </div>
  );
